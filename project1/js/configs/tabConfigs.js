...
export const overviewSectionsConfig = [
  {
    ...
    data: [
      { label: 'Population', id: 'totalPopulationO', unit: '', format: '' },
      {
        ...
        id: 'populationGrowthO',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Population Density',
        id: 'populationDensityO',
        unit: 'per km&sup2;',
        format: '',
      },
      {
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        id: 'gdpPerPersonEmployedO',
        unit: 'USD',
        format: 'usd',
      },
      {
        label: 'Unemployment Rate',
        id: 'unemploymentRateO',
        unit: '%',
        format: 'pct',
      },
    ],
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        id: 'healthExpenditureO',
        unit: 'USD',
        format: 'usd',
      },
    ],
    charts: [{ id: 'birthDeathRateChart', title: 'Birth and Death Rate (%)' }],
  },
  {
    ...
    data: [
      {
        label: 'Population Exposed to Pollution (PM2.5)',
        id: 'popExposedPolutionO',
        unit: '% of pop',
        format: 'pct',
      },
      {
        label: 'Renewable Energy Consumption',
        id: 'renewableEnergyConsumptionO',
        unit: '% of total energy consumption',
        format: 'pct',
      },
      {
        label: 'Renewable Energy Output',
        id: 'renewableEnergyOutputO',
        unit: '% of total energy output',
        format: 'pct',
      },
    ],
    charts: [],
...
export const healthSectionsConfig = [
  {
    ...
    data: [
      ...
      {
        label: 'Mortality from Non-Communicable Diseases',
        id: 'mortalityNonCommunicable',
        unit: '% of Pop',
        format: 'pct',
      },
    ],
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        id: 'nurseMidwirePerCap',
        unit: 'per Capita',
        format: '',
      },
      {
        label: 'Hospital Beds',
        id: 'hospitalBedsperCap',
        unit: 'per Capita',
        format: '',
      },
    ],
  ...
  },
  {
    ...
    charts: [{ id: 'smokingSexDistribution', title: 'Population who Smoke' }],
  },
];
...
export const populationSectionsConfig = [
  ...
  },
  {
    ...
    data: [
      {
        label: 'Dependency Ratio (Elderly)',
        id: 'dependencyRatioOld',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Dependency Ratio (Young)',
        id: 'dependencyRatioYoung',
        unit: '%',
        format: 'pct',
      },
    ],
    charts: [
      ...
      {
        id: 'genderChart',
        title: 'Total Population Sex Distribution',
        unit: '%',
      },
      {
        id: 'parliamentChart',
        title: 'Parliament Sex Distribution',
        unit: '%',
      },
      {
        id: 'managementChart',
        title: 'Management Sex Distribution',
        unit: '%',
      },
    ],
  },
    ...
    data: [
      {
        ...
        id: 'schoolEnrollPctPrimary',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Secondary School Enrollment',
        id: 'schoolEnrollPctSecondary',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Tertiary School Enrollment',
        id: 'schoolEnrollPctTertiary',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Progress to Secondary School',
        id: 'progressToSecondaryPct',
        unit: '%',
        format: 'pct',
      },
      {
        label: 'Adolescents Out of School',
        id: 'adolescentOutOfSchoolPct',
        unit: '%',
        format: 'pct',
      },
    ],
...
export const environmentSectionsConfig = [
  {
    ...
    data: [
      {
        label: 'Particulate Matter Emissions (PM2.5)',
        id: 'particulateMatterEmissions',
        unit: 'micrograms per cubic meter',
        format: '',
      },
      {
        label: 'Population Exposed to Pollution (PM2.5)',
        id: 'popExposedPolution',
        unit: '% of pop',
        format: 'pct',
      },
    ],
  ...
  },
  {
    ...
    data: [
      ...
      {
        label: 'Protected Total Area',
        id: 'protectedTotalArea',
        unit: '% of total territory',
        format: 'pct',
      },
      {
        label: 'Protected Marine Area',
        id: 'protectedMarineArea',
        unit: '% of total marine area',
        format: 'pct',
      },
      {
        label: 'Protected Land Area',
        id: 'protectedLandArea',
  ...
  },
  {
    ...
    data: [
      ...
      },
      {
        label: 'Water Stress',
        id: 'waterStress',
        unit: '% of renewable water resources withdrawn',
        format: 'pct',
      },
    ],
    charts: [],
